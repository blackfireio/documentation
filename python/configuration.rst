...
The preferred way to configure the Python probe is via environment variables.
That allows you to change the configuration without modifying your code:
...
Configuring the Probe via Python Code
-------------------------------------

You can also configure the probe from your :ref:`Python code
<probe-configuration-python>`.
